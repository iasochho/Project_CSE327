...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          _buildSliverAppBar(context), // Passed context
          SliverToBoxAdapter(
            child: Padding(
    ...
    return Column(
      ...
      children: [
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: NetworkImage(user.avatarUrl.isNotEmpty ? user.avatarUrl : 'https://via.placeholder.com/150'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(color: Color(0xFF00685F), shape: BoxShape.circle),
        ...
        const Text(
          ...
          style: TextStyle(color: Color(0xFF5C5F60), height: 1.5, fontSize: 14),
        ),
        const SizedBox(height: 24),
        Row(
          children: [
            ...
            const SizedBox(width: 32),
            _buildStatItem(user.totalWorkouts.toString(), 'Workouts', isHighlight: true),
          ],
        ),
      ],
    );
  ...
  Widget _buildFollowButton() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: const Color(0xFF005DA7).withOpacity(0.2), blurRadius: 20, offset: const Offset(0, 8))
        ],
      ),
      child: const Text(
        'FOLLOW',
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            ...
            fontWeight: FontWeight.bold,
            letterSpacing: -1,
            color: isHighlight ? const Color(0xFF00685F) : const Color(0xFF1A1C1C),
          ),
        ),
        Text(
          label.toUpperCase(),
          style: const TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: Color(0xFF94A3B8), letterSpacing: 1),
        ),
      ],
    );
  }

  Widget _buildAchievementChips(UserModel user) {
    return Wrap(
      spacing: 12,
      runSpacing: 12,
      children: [
        ...
        _buildChip(Icons.local_fire_department, '${user.dayStreak} Day Streak', const Color(0xFFBA1A1A)),
      ],
    );
  }
  ...
  Widget _buildChip(IconData icon, String label, Color iconColor) {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFFDEE0E2), borderRadius: BorderRadius.circular(20)),
      child: Row(
        ...
        children: [
          ...
          Text(
            label.toUpperCase(),
            style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Color(0xFF444749)),
          ),
        ],
      ),
    );
  ...
  Widget _buildTabItem(String label, {bool isActive = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(bottom: BorderSide(color: isActive ? const Color(0xFF005DA7) : Colors.transparent, width: 2)),
      ),
      child: Text(
        label.toUpperCase(),
        style: TextStyle(
          ...
          fontWeight: FontWeight.bold,
          letterSpacing: 1,
          color: isActive ? const Color(0xFF005DA7) : const Color(0xFF94A3B8),
        ),
      ),
    );
  }
